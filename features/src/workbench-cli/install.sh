...
cd /tmp
${RUN_AS_LOGIN_USER} ". \${SDKMAN_DIR}/bin/sdkman-init.sh && curl -L https://storage.googleapis.com/${cliDistributionPath#gs://}/download-install.sh | TERRA_CLI_SERVER=${SERVER} bash"
...
${RUN_AS_LOGIN_USER} "ls -al ${USER_HOME}"
