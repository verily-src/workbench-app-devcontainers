...
- Workflow integration (Salmon/FastQC submission -- format TBD from Yunhai Luo)
...
3. **Export format** -- What downstream tool consumes the export? CSV sample manifest with (sample_id, fastq1, fastq2) columns? Or Nextflow params.json? **Must be confirmed with Yunhai Luo before Phase 2.**
