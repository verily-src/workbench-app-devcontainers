...
Custom Workbench application based on mcr.microsoft.com/devcontainers/base:ubuntu-24.04.
...
Once deployed in Workbench, access your terminal at the app URL (port 8080).
...
4. Select this app template (enrichment-authoring)
