...
# csv_scanner.sh scans the mounted workspace to find CSV files and copies them to the required directory.
# This script monitors /home/shiny/workspace for CSV files and copies them to /srv/shiny-server/verily_cost/
# when they are found and are not yet in the destination directory.
