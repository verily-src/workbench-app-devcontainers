...
export default function Passport() {
  const { passportMetrics, isLoading } = useData()
  ...
  const displayN = searchResults ? searchResults.matched_patients : displayCount
  const totalN = displayCount
    ...
    <div>
      <div style={{
        ...
        <p style={{ color: 'rgba(26, 26, 26, 0.6)', fontSize: '14px', marginBottom: '24px' }}>
          Complete overview of dataset structure, coverage, and population characteristics
        </p>
