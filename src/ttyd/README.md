...
Custom Workbench application based on .
...
Once deployed in Workbench, access your terminal at the app URL (port 2222).

For local testing:
1. Create Docker network: `docker network create app-network`
2. Run the app: `devcontainer up --workspace-folder .`
3. Access at: `http://localhost:2222`
...
4. Select this app template (ttyd)
