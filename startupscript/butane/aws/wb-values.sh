...
# the wb (workbench) container in AWS environments. These values are sourced by
...
# - WB_LOGIN_MODE: Authentication method for AWS services
...
# Authentication mode for AWS services
readonly WB_LOGIN_MODE="AWS_IAM"
