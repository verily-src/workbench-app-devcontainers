...
# the wb (workbench) container in Azure environments. These values are sourced by
...
# - WB_LOGIN_MODE: Authentication method for Azure services
...
readonly WB_LOGIN_MODE="AZURE_ATTESTED_DATA"
